...
tk_init.SCENES_NUM = 2;

tk_init.TrackControl = function TrackControl(registry, host, device, transport, track, application) {
	var self = this;
	this.trackBank;
	...
	this.init = function() {
		self.trackBank = host.createMainTrackBank(4, 2, tk_init.SCENES_NUM);
